...
class E_Books(models.Model):
    ...
    book_desc = models.TextField(max_length=255, default="Django for Beginners is a project-based introduction to Django, the popular Python-based web framework. Suitable for total beginners who have never built a website before as well as professional programmers looking for a fast-paced guide to modern web development and Django fundamentals.")
...
class PCS_Cloud(models.Model):
    ...
    session_desc = models.TextField(max_length=255, default="Java Enterprise edition has changed and evolved a lot over the years. This course is about teaching you what JEE is, and how to use it and become a productive JEE developer. The course focuses on JEE 8 (also known as Jakarta EE).")
